...
export default async function LoginPage({
  ...
  return (
    <main className="flex flex-1 flex-col md:min-h-[calc(100dvh-5rem)] md:items-center md:justify-center md:px-4">
      <LoginEnter>
        <div className="flex w-full flex-col max-md:min-h-[calc(100dvh-3.5rem-env(safe-area-inset-top,0px))] max-md:justify-between max-md:bg-background md:max-w-xl md:justify-center lg:max-w-lg">
          <div className="flex flex-1 flex-col justify-center bg-background px-6 py-10 md:rounded-2xl md:border md:border-border md:bg-card md:px-10 md:py-12 md:shadow-sm sm:px-8 sm:py-11">
